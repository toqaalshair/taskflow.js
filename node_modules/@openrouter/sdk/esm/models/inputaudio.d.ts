...
export declare const InputAudioFormat: {
    readonly Mp3: "mp3";
    readonly Wav: "wav";
};
...
/** @internal */
export declare const InputAudioFormat$inboundSchema: z.ZodType<InputAudioFormat, unknown>;
/** @internal */
export declare const InputAudioFormat$outboundSchema: z.ZodType<string, InputAudioFormat>;
/** @internal */
